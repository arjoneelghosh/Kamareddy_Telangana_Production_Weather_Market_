...
SELECT
    ...
    NULLIF(TRY_CAST(Humidity_Min AS DOUBLE), 0) AS hum_min,
    NULLIF(TRY_CAST(Humidity_Max AS DOUBLE), 0) AS hum_max,
...
SELECT
    ...
    NULLIF(TRY_CAST("Min Humidity (%)" AS DOUBLE), 0) AS hum_min,
    NULLIF(TRY_CAST("Max Humidity (%)" AS DOUBLE), 0) AS hum_max,
